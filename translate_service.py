...
PROMPT_TEMPLATE = """You will translate Korean cosmetics/beauty e-commerce product names into English.
...
- Translate ingredient names, product types, and marketing phrases into natural English used on beauty e-commerce sites.
...
def sync_translations(conn, max_items=None):
